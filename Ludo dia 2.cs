...
namespace ConsoleApp1
{
    class Program
    {
        ...
        public static void funcaoPuloJ1() { //Ajuda a pular a vez do Jogador 1 para o jogador 2
        }
        public static void funcaoPuloJ2(){  //Ajuda a pular a vez do Jogador 2 para o jogador 1
        }
        ...
        public static int[,] tabuleiroEscolherPeçaJ2(int P1,int P2,int P3, int P4, int[,] tabuJ2)
        {
        ...
        public static void menuJ2(int[,] tabuJ2) //menu do jogador 2
        {
            ...
            switch (opcoesJ2)
            {
                case 0:
                    ...
                    int contadorDeSeis = 0;
                    verificarDadoJ2(dado, contadorDeSeis,tabuJ2);
                    break;
                case 1:
                    break;
                default:
        ...
        public static void verificarDadoJ2(int dado, int contadorDeSeis,int[,] tabuJ2) // Verifica o valor tirado pelo dado do jogador 2
        {
        ...
        public static void escolherPeaoJ2Seis(int dado,int[,] tabuJ2) // Escolhe o a peça que ira sair para o tabuleiro
        {
            Console.WriteLine("============================================================");
            Console.WriteLine("\nParabéns Jogasor 2! voce tirou 6!!");
            Console.WriteLine("\nEscolha uma das peças para colocar no tabuleiro: \n 1-Para peça 1 \n 2-Para peça 2 \n 3-Para peça 3 \n 4-Para peça 4");
            Console.WriteLine("\nSe quiser movimentar uma peça pressione 0");
            int escolhaPeca = int.Parse(Console.ReadLine());
            int P1=0,P2=0 ,P3=0,P4 = 0;
