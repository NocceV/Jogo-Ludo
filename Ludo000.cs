 P2, P3, P4, tabu, O1, O2, O3, O4, tabuJ2, contadorDeSeis);
                    break;
                default:
...
namespace ConsoleApp1
{
    class Program
    {
        ...
        public static void menuJ1(int P1, int P2, int P3, int P4, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis) // menu do jogador 1
        {
            ...
            switch (opcoesJ1)
            {
                case 0: //gira o dado voce tem dado em casa
        ...
        public static void movimentarPecaJ1(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis) //movimenta as peças no tabuleuro
        {
            ...
            switch (peca)
            {
                ...
                case 1:
                    ...
                    if (A == 1)
                    {
                        verificaGanhaP1(P1, P2, P3, P4, dado, tabu, O1, O2, O3, O4, tabuJ2, contadorDeSeis);
                ...
                case 2:
                    ...
                    if (B == 2)
                    {
                        verificaGanhaP2(P1, P2, P3, P4, dado, tabu, O1, O2, O3, O4, tabuJ2, contadorDeSeis);
                        movimentarP2(P2, dado, tabu);
                ...
                case 3:
                    ...
                    if (C == 3)
                    {
                        verificaGanhaP3(P1, P2, P3, P4, dado, tabu, O1, O2, O3, O4, tabuJ2, contadorDeSeis);
                        movimentarP3(P3, dado, tabu);
                ...
                case 4:
                    ...
                    if (D == 4)
                    {
                        verificaGanhaP4(P1, P2, P3, P4, dado, tabu, O1, O2, O3, O4, tabuJ2, contadorDeSeis);
                        movimentarP4(P4, dado, tabu);
        ...
        public static void verificaGanhaP1(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis)//verifica se a peça 1 chegou no final
        {
            for (int j = 0; j < 57; j++)
            {
                if (tabu[0, j] == 1)
        ...
        public static void verificaGanhaP2(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis)//verifica se a peça 2 chegou no final
        {
            for (int j = 0; j < 57; j++)
            {
                if (tabu[1, j] == 2)
        ...
        public static void verificaGanhaP3(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis)//verifica se a peça 3 chegou no final
        {
            for (int j = 0; j < 57; j++)
            {
                if (tabu[2, j] == 3)
        ...
        public static void verificaGanhaP4(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis)//verifica se a peça 4 chegou no final
        {
            for (int j = 0; j < 57; j++)
            {
                if (tabu[3, j] == 4)
        ...
        public static void movimentarPecaJ2(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis) //movimenta peças no tabuleiro
        {
            ...
            switch (peca)
            {
                ...
                case 1:
                    ...
                    if (A == 1)
                    {
                        verificaGanhaO1(P1, P2, P3, P4, dado, tabu, O1, O2, O3, O4, tabuJ2, contadorDeSeis);
                ...
                case 2:
                    ...
                    if (B == 2)
                    {
                        verificaGanhaO2(P1, P2, P3, P4, dado, tabu, O1, O2, O3, O4, tabuJ2, contadorDeSeis);
                ...
                case 3:
                    ...
                    if (C == 3)
                    {
                        verificaGanhaO3(P1, P2, P3, P4, dado, tabu, O1, O2, O3, O4, tabuJ2, contadorDeSeis);
                        movimentarO3(O3, dado, tabuJ2);
                        Console.WriteLine("Peça 3 escolhida ela irá movimentar " + dado + " casas");
                ...
                case 4:
                    ...
                    if (D == 4)
                    {
                        verificaGanhaO4(P1, P2, P3, P4, dado, tabu, O1, O2, O3, O4, tabuJ2, contadorDeSeis);
                        movimentarO4(O4, dado, tabuJ2);
                        Console.WriteLine("Peça 4 escolhida ela irá movimentar " + dado + " casas");
        ...
        public static void verificaGanhaO1(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis)//verifica se a peca 1 chegou no final
        {
        ...
        public static void verificaGanhaO2(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis)//verifica se a peca 2 chegou no final
        {
        ...
        public static void verificaGanhaO3(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis)//verifica se a peca Tres chegou no final
        {
        ...
        public static void verificaGanhaO4(int P1, int P2, int P3, int P4, int dado, int[,] tabu, int O1, int O2, int O3, int O4, int[,] tabuJ2, int contadorDeSeis)//verifica se a peca 4 chegou no final
        {
